...
```
Phase 1  ████████████████████  ✅  🚪 GATE 1 පසුයි
Phase 2  ██████████████████░░  🟨  ≈92%   (papers කියවීම ඉතුරුයි — හදිසි නෑ)
Phase 3  ████████████████████  ✅  🚪 GATE 3 පසුයි — DESIGN FROZEN
Phase 4  ████████████████████  ✅  දත්ත සූදානම් · T5.1, T5.2 ද ඉවරයි
Phase 5  ░░░░░░░░░░░░░░░░░░░░  🟨  ← ★ දැන් මෙතන
```

### 👉 කරන්න ඕන දේ: **T5.3 — SimPy factory skeleton**

> ⚙️ **පරිසරය සූදානම්:** packages ඔක්කොම install කරලා, `src/config.yaml` එකේ **parameters සියල්ල**
> තියෙනවා, `data/processed/` එකේ CSV 4ක් (machine · operator · task · skill) සූදානම්.
> ⛔ **Code එකේ කිසිම අගයක් hard-code කරන්න එපා** — හැම එකක්ම `config.yaml` එකෙන් කියවන්න.
...
```
┌────────────────────────────────────────────────────────────┐
│  1️⃣  09-worklog.md කියවන්න          ← ★★★ මුලින්ම මේක      │
│      කලින් session එකේ මොකද කලේ, මොන තීරණ ගත්තද            │
│                                                            │
│  2️⃣  src/config.yaml කියවන්න                               │
│      හැම parameter එකක්ම එතන. [FROZEN]/[TUNABLE]/[CALIB]   │
│      කියලා ලකුණු කරලා තියෙනවා                              │
│                                                            │
│  3️⃣  src/README.md — ලිවීමේ අනුපිළිවෙල                     │
│                                                            │
│  4️⃣  T5.3 — SimPy factory skeleton ලියන්න                  │
