...
> ★★ **මේකයි v1 එකට වඩා ලොකුම දියුණුව.** `0.80` කියන අගය දැන් **හැම operator කෙනෙකුටම වෙනස්
> නිරපේක්ෂ මට්ටමකට** පරිවර්තනය වෙනවා — ඒක v1 හි තිබූ පොදු threshold එකට වඩා හාත්පසින්ම හොඳයි.

#### ⚠️ නිවැරදි කිරීම (2026-08-05) — **0.80 එක ප්‍රභවයකින් නොවේ**

> ඉහත ඡේදයේ මුල් අනුවාදයේ මෙසේ තිබුණි: *"Reviewer කෙනෙක් '0.80 කොහෙන්ද?' කියලා ඇහුවොත්
> උත්තරය: 'පිළිගත් acceptable work level එකෙන් 80%, එය Price (1990) අනුව ගණනය කර ඇත.'"*
>
> ⛔ **ඒ උත්තරය ප්‍රශ්නයට උත්තර දෙන්නේ නෑ.** ඒකෙන් කියවෙන්නේ 0.80 කියන්නේ **මොකකින්** 80%ද
> කියන එක පමණි. **ඇයි 0.80, 0.70 හෝ 0.90 නොවේ** කියන එකට උත්තරයක් නෑ — ඒක **වට්ටෝරුවකි**.

| කොටස | ප්‍රභවය |
|---|---|
| **AWL** (100% ලක්ෂ්‍යය) | ✅ **Price (1990)** `price1990relaxation` · වයස් සාධකය Silva et al. (2016) |
| **0.80** (ආන්තිකය) | ⚠️ **අපගේ තේරීමකි.** කිසිම ප්‍රකාශනයක නොමැත |

> ★ **මේක λ, μ ගේම තත්ත්වයයි** — ආකෘතිය/පදනම සාහිත්‍යයෙන්, නිශ්චිත අගය අපගෙන්.
> ➜ ඒ නිසා **එකම ප්‍රතිකර්මය:** `[CALIB]` ලෙස ප්‍රකාශ කර, **T7.6b හි 0.70/0.80/0.90 sweep**
> එකකින් ආවරණය කරන්න. *(`src/config.yaml` හි ලකුණු කර ඇත.)*
>
> ⛔ **ලියන්න එපා:** *"HC1 = 0.80 following Price (1990)"*
> ✅ **ලියන්න:** *"80% of each operator's acceptable work level, a safety margin chosen
> for this study rather than a published constant; its influence is assessed in §V-D."*
>
> 💡 **HC3 (RULA ≤ 5), ψ₁ = 2.0, ψ₂ = 1.0 ද එකම තත්ත්වයේ** — RULA පරිමාණය ප්‍රකාශිතයි,
> **සීමාව සහ ගුණකයන් අපගේ**. ඒවා T7.8 ablation එකෙන් ආවරණය වේ.
