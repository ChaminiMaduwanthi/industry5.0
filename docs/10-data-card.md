...
> ඒ නිසා **`β₂` (skill) සහ `β₃` (fatigue) කිසිම dataset එකකින් fit කරන්න බෑ.**
> ➜ ඒවා **λ, μ වගේම `[CALIB]`** — measured නොවේ. **T7.8 ablation** එකෙන් ආවරණය කරන්නම ඕන.
> ➜ මේක §VI Limitations එකේ ලියන්න.

#### 🔧 β coefficients calibrate කරපු හැටි (2026-08-05)

Anchor **2ක්** පාවිච්චි කළා — mean එක විතරක් මදි:

| Anchor | තත්ත්වය | ඉලක්කය |
|---|---|---|
| **Reference** | H=1.00 · S=0.70 · F̂=0.30 · κ=1.0 | **6.64%** ← SECOM හි මැනපු අගය |
| **Worst feasible** | H=0.30 · S=0.40 · F̂=0.80 · κ=1.4 | **25%** ← HC1–HC4 විසින් අවසර දෙන නරකම තත්ත්වය |

> ⚠️ **ඇයි anchor දෙකක්?** මුලින් තිබුණේ mean එකට විතරක් ගැලපෙන අගයන් (β₀ = −4.00).
> ඒවා reference එකේදී **6.98%** — හොඳයි. ඒත් constraint සීමාවේදී **61%** —
> **කිසිම කර්මාන්තශාලාවක එහෙම නෑ.** Slope 0.508කින් අඩු කරලා β₀ නැවත විසඳුවා.
>
> ✅ මේ anchor දෙක `build_processed.py` එකේ **assert** කරලා තියෙනවා — කවුරුහරි β වෙනස් කළොත් **වහාම කැඩෙනවා**.
