...
def main() -> None:
    ...
    print("    filter, 95.8% of decisions in this scenario face a feasible set")
    print("    of zero or one candidate — there is nothing to weigh. In the")
    print("    4.2% that offer a real choice, the spread between best and")
    print("    worst score has a median of 0.016.")
    print()
